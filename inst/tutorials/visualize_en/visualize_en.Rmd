...
> Hint: ggplotting is similar to commonly used Photoshop editing, where you first create a basic image and then add filter effects layer by layer.
...
> Hint: Each type of graphical attribute has a default scale, which can be used not only to change the ratio but also to change the color in plotting.
