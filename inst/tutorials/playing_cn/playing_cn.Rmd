...
knitr::include_graphics("D:/Dropbox/Seafile/WW/01_Instruction/Research/R packages/drhur/inst/tutorials/playing/images/handShadow.gif")
```
...
```{r out.width = "60%", echo = FALSE}
knitr::include_graphics("../playing/images/APLkeyBoard.png")
```
...
```{r out.width = "60%", echo = FALSE}
knitr::include_graphics("../playing/images/matrix.gif")
```
...
knitr::include_graphics("../playing/images/excel-r1.png")
```
...
```{r rstudio}
knitr::include_graphics("../playing/images/excel-r2.png")
```
...
knitr::include_graphics("../playing/images/rowBind.png")
```
...
```{r out.width = "95%", echo = FALSE}
knitr::include_graphics("../playing/images/columnBind.png")
```
...
```{r out.width = "95%", echo = FALSE}
knitr::include_graphics("../playing/images/join.png")
```
