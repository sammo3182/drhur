...
```{r toy}
wvs7 <- readRDS("/Users/zhumeng/Desktop/Fall semester_2021/Politics analysis/code/WVS7.rds")
View(wvs7)
```
...
wvs7_China <- wvs7[wvs7$country == "156", 96:98]
wvs7_Japan <- wvs7[wvs7$country == "392", 96:98]

# rename cloname
wvs7_China <- rename(wvs7_China, 
                     "trustCom" = "Q57",
                     "trustFam"="Q58",
                     "trustNei"="Q59")
wvs7_Japan <- rename(wvs7_Japan,
                     "trustCom" = "Q57",
                     "trustFam"="Q58",
                     "trustNei"="Q59")
...
wvs7_country <- select(wvs7,country, year)
wvs7_year <- select(wvs7,year, D_INTERVIEW)
```
